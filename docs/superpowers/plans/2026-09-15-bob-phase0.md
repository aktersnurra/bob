...
- The stock opam switch `default` (OCaml 5.5.1) has: `eio_main.1.5`,
...
If `opam switch show` reports anything other than `default`, run
`opam switch set default` before building.
